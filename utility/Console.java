...
public class Console {
    ...
    public int scriptMode(String argument) {
        ...
        try (Scanner scriptScanner = new Scanner(new File(argument))) {
            ...
            Scanner tmpScanner = workerAsker.getUserScanner();
            workerAsker.setUserScanner(scriptScanner);
            workerAsker.setFileMode();
            do {
            ...
            workerAsker.setUserScanner(tmpScanner);
            workerAsker.setUserMode();
    ...
    private int launchCommand(String[] userCommand) {
        switch (userCommand[0]) {
            ...
            case "count_greater_than_position":
                if (!commandManager.countGreaterThanPositionCommand(userCommand[1])) return 1;
                break;
            case "sort":
